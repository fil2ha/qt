...
class Ui_MainWindow(object):
    data_addedd = QtCore.pyqtSignal(str, str, str, str, str, str)
    ...
    def add_info(self):
        ...
        image = self.lineEdit_4.text()
        desc = self.lineEdit_5.text()
        store = self.lineEdit_6.text()
        self.data_addedd.emit(name, amount, price, image, desc, store)
        self.lineEdit.clear()
