...
class Ui_MainWindow(QtCore.QObject):
    data_added = QtCore.pyqtSignal(str, str)
    ...
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(20, 160, 641, 48))
        ...
        self.lineEdit.setPlaceholderText("координаты склада")
    ...
    def add_info(self):
        coor = self.lineEdit.text()
        geo = self.lineEdit_2.text()
        self.data_added.emit(coor, geo)
        self.lineEdit.clear()
