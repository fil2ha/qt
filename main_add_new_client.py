...
class Ui_MainWindow(QObject):
    data_added1 = QtCore.pyqtSignal(str, str, str, str)
    ...
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(20, 100, 651, 100))
        ...
        self.lineEdit_3.setPlaceholderText("Введите какой-то тип")
        self.verticalLayout.addWidget(self.lineEdit_3)
        self.lineEdit_4 = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.lineEdit_4.setPlaceholderText("Введите, хз, дополнительную информацию")
    ...
    def add_info(self):
        ...
        telephone = self.lineEdit_2.text()
        type = self.lineEdit_3.text()
        column_6 = self.lineEdit_4.text()
        ...
        self.data_added1.emit(Fio, telephone, type, column_6)
